...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest a CSV file into a normalized Phase 0 dataset.")
    ...
    print(f"Ingested {count} {args.dataset} rows into {args.output}.")
    return 0
